            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-12">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-2">Task Manager</h1>
                            <p class="text-gray-600 dark:text-gray-300">Organize your work and boost productivity</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-orange-600 dark:text-orange-400 mt-2">0</p>
                            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                            ...
                            <div class="p-6">
                                <button class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-lg mb-4 transition duration-200">
                                    + New Project
                                </button>
                                <div class="space-y-2">
                                    <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 cursor-pointer transition">
                                        <p class="text-sm font-medium text-gray-900 dark:text-white">No projects yet</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Create your first project</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                            <div class="bg-gradient-to-r from-blue-500 to-cyan-600 px-6 py-4 flex items-center justify-between">
                                ...
                                <button class="bg-white text-blue-600 hover:bg-blue-50 font-medium py-2 px-4 rounded-lg transition duration-200">
                                    + Add Task
                                </button>
                            </div>
                            <div class="p-6">
                                <!-- Task Form -->
                                <form class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <div class="space-y-4">
                                        <input 
                                            type="text" 
                                            placeholder="Task title..." 
                                            class="w-full px-4 py-2 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:text-white"
                                        />
                                        <div class="grid grid-cols-2 gap-4">
                                            <select class="px-4 py-2 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:text-white">
                                ...
                                <!-- Tasks List -->
                                <div class="space-y-3">
                                    <div class="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:shadow-md transition">
                                        <div class="flex items-center space-x-3">
                                            <input type="checkbox" class="w-5 h-5 text-blue-600 rounded focus:ring-2 focus:ring-blue-500" />
                                            <div class="flex-1">
                                                <p class="font-medium text-gray-900 dark:text-white">No tasks yet</p>
                                                <p class="text-sm text-gray-500 dark:text-gray-400">Add a new task to get started</p>
                                            </div>
                                            <span class="px-2 py-1 text-xs font-semibold bg-gray-100 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded">Medium</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
